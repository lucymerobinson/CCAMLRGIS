...
#'
#' @param format "GEOJSON" will extract the latest Statistical Areas and Division geographical reference data from the CCAMLR GIS geoserver and "RDATA" will use the Spatial Polygon Data Frame last saved with the package
