...
It is useful to create spatial line data to represent longline sets or vessel or animal tracks. The create_Lines function has been developed to create spatial lines that conform to CCAMLR's standards/specifications that can be used in analyses or to generate maps in R. 

see ?create_Lines for function specifications

### Example of creating lines that represent two longline sets that each have start and end coordinates
```{r}
