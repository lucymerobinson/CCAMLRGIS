...
It can be useful to useful to create spatial point data to represent survey sites, fishing locations and VME locations. The create_Points function has been developed to create spatial points that conform to CCAMLR's standards/specifications that can be used in analyses or to generate maps in R. 
